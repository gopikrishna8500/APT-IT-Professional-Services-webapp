  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-slate-800 mb-12">Our Vision & Mission</h2>
          <div className="space-y-12">
            {/* Vision Statement */}
            <div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Vision Statement</h3>
      ...
      {/* Footer and copyright section at the very bottom */}
      <Footer />
