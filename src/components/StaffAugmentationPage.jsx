            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-md">
              ...
              {openAccordion === 'contract-staffing' && (
                <div className="bg-gray-50 px-6 py-4 space-y-4">
                  ...
                  <p className="text-gray-600">
                    At APT IT Professional Services, contract staffing is not just a quick fix; it is a strategic answer to your call that streamlines those tightest timeframes, keeps the project on time, meets your budget, and keeps you ahead in this ever changing-market.
                  </p>
